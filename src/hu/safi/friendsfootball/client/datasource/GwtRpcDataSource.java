...
import hu.safi.friendsfootball.client.FriendsfootballServiceAsync;
...
public abstract class GwtRpcDataSource
	...
	protected final FriendsfootballServiceAsync footballService = GWT.create(FriendsfootballService.class);
