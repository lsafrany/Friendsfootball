...
public class MatchDataSource
    ...
    public MatchDataSource () {
        ...
        field = new DataSourceTextField (ClientConstants.MATCH_PLACE, ClientLabels.MATCH_PLACE);
        addField (field);
    ...
    protected void executeFetch (final String requestId, final DSRequest request, final DSResponse response) {
    	...
    	if (request.getAttribute(ClientConstants.ATTRIBUTE).equals(ClientConstants.ATTRIBUTE_ALL))  {
    		footballService.matches (request.getAttribute(ClientConstants.PLAYER_KEY),new AsyncCallback<List<MatchSer>> () {
       		...
       		footballService.matchesByRight (request.getAttribute(ClientConstants.PLAYER_KEY),new AsyncCallback<List<MatchSer>> () {
    			public void onFailure (Throwable caught) {
    				response.setStatus (RPCResponse.STATUS_FAILURE);
    				processResponse (requestId, response);
    			}
    ...
    protected void executeUpdate (final String requestId, final DSRequest request, final DSResponse response) {
        ...
        if (request.getAttribute(ClientConstants.ATTRIBUTE).equals(ClientConstants.ATTRIBUTE_ALL)) {       
	        footballService.updateMatch (matchSer, new AsyncCallback<MatchSer> () {
 	        ...
 	        footballService.updateMatchByRight (matchSer, new AsyncCallback<MatchSer> () {
	            public void onFailure (Throwable caught) {
	                response.setStatus (RPCResponse.STATUS_FAILURE);
	                processResponse (requestId, response);
	            }
